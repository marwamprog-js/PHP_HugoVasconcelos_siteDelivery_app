...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="text-sm"><small><?php echo $_SESSION['email_usuario'];  ?></small></p>
                                    <p class="text-sm text-muted">
                                        <i class="far fa-clock mr-1"></i> <small>Último Pedido - 10/05/2023</small>
                                    </p>
                                </div>
                            </div>
                            <!-- Message End -->
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2023 <a href="http://adminlte.io">Hugo Vasconcelos</a>.</strong>
            All rights reserved.
